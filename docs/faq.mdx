...
<AccordionGroup>
  ...
  <Accordion title="Which model providers are supported?">
    OpenSRE supports Anthropic, OpenAI, OpenRouter, DeepSeek, Gemini, Bedrock,
    Azure OpenAI, and CLI-backed providers. Set `LLM_PROVIDER` and the matching
    API key. Provider matrix, defaults, and troubleshooting:

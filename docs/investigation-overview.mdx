...
| "investigate this alert file" | `/investigate` or `opensre investigate -i …` after you have a payload |
...
For hosted OpenSRE runtimes, see [Remote runtime investigation](/remote-runtime-investigation) and [Deployment](/deployment).

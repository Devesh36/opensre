...
| Variable | Default | Description | Module |
|----------|---------|-------------|--------|
| `TRACER_VERBOSE` | `0` | Verbose OpenSRE CLI/UI output (`1`, `true`, `yes`) | `surfaces/interactive_shell/ui/output` |
| `TRACER_OUTPUT_FORMAT` | | OpenSRE result output format | `platform/observability/output_format` |
| `TRACER_API_URL` | | Base URL for the tracer observability integration / report delivery | `integrations/tracer` |
...
| `SLACK_DEFAULT_CHAT_ID` | | Default Slack channel for scheduled delivery (bot-token path) | `platform/scheduler/credentials`, `integrations/slack/setup` |

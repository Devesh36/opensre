...
Session-local async investigation mode. Launch an RCA, keep using the shell, and get the finished report delivered to email, Telegram, or Rocket.Chat.
...
| `/background notify set &lt;channel[,channel...]&gt;` | Set channels — `email`, `telegram`, `rocketchat`, or a combination |

...
from gateway.discord.thread_history import (
...
class DiscordTurnDispatcher:
    ...
    def _post(self, inbound: DiscordInboundMessage, text: str) -> None:
        from gateway.discord.client import send_message
        ...
        with self._conversation_turn(inbound.conversation_key):
            ...
            try:
                ...
                if inbound.attachments:
                    from gateway.discord.attachments import build_discord_attachments_context

...
class TestThemeRegistry:
    ...
    def test_theme_registry_entries_include_required_semantic_tokens(self) -> None:
        from app.cli.interactive_shell.ui.theme import get_theme, list_theme_names
    ...
    def test_lazy_rich_tokens_track_active_theme(self) -> None:
        from app.cli.interactive_shell.ui.theme import BOLD_BRAND, HIGHLIGHT, set_active_theme

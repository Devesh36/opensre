...
def _reset_active_theme() -> None:
    ...
    ``app.cli.interactive_shell.ui.theme``, which persists across tests
    and can cause order-dependent failures. This fixture restores the
    default before every test in this directory.
    """

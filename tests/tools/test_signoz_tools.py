...
from integrations.signoz.tools.signoz_tools import (
...
class TestQuerySignozLogs:
    def test_available_with_query_api_credentials_only(self) -> None:
        from integrations.signoz.tools.signoz_tools import _logs_is_available
...
class TestQuerySignozTraces:
    def test_available_with_query_api_credentials_only(self) -> None:
        from integrations.signoz.tools.signoz_tools import _traces_is_available

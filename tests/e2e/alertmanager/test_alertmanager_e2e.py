...
class TestAlertmanagerToolsAvailability:
    ...
    def test_alertmanager_alerts_tool_importable(self):
        ...
        from integrations.alertmanager.tools.alertmanager_tools import (
    ...
    def test_alertmanager_alerts_tool_not_available_without_source(self):
        ...
        from integrations.alertmanager.tools.alertmanager_tools import alertmanager_alerts
    ...
    def test_alertmanager_silences_tool_run_success(self, mock_list_silences):
        ...
        from integrations.alertmanager.tools.alertmanager_tools import alertmanager_silences
